...
@Autonomous(name = "OpenCV_BlueAutonomous_Backside")

public class OpenCV_Blue_Backside extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        if (opModeIsActive()) {
            ...
            //Randomized towards the middle spike
            if (reference == 1) {
                //Move towards Pixel
                moveY(0.5, 1000);

                //Turn 100 degrees to face middle spike
                turn(0.5, 1750);
                ...
                //turn 90 degrees counter clockwise, back facing board
                turn(-0.5, 875);
            ...
            if (reference == 2) {
                ...
                //strafe left
                moveX(-0.5, 800);
                //Move forwards to park or back? (claw miight be in the way)
                moveY(0.5, 3000);
